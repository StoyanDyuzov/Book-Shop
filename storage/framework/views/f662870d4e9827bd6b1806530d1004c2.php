...
<head>
    ...
    <title>Admin Dashboard - Find User</title>
    <!-- Import Google Font -->
...
<body>
    <div class="container">
        ...
        <div class="right-section">
            ...
            <form action="<?php echo e(route('adminFindUserSubmit')); ?>" method="post">    
                <?php echo csrf_field(); ?>
            ...
            <?php if(session('user')): ?>
                <div class="user-details">
                    <h1>Id: <?php echo e(session("user")->id); ?></h1>
                    <h1>First name: <?php echo e(session("user")->first_name); ?></h1>
                    <h1>Last name: <?php echo e(session("user")->last_name); ?></h1>
                    <h1>Username: <?php echo e(session("user")->username); ?></h1>
                    <h1>Email: <?php echo e(session("user")->email); ?></h1>
                    <h1>Role: <?php echo e(session("user")->role); ?></h1>
                </div>
            <?php endif; ?>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\LARAVEL\book-store\resources\views/adminFindUser.blade.php ENDPATH**/ ?>